// src/components/auth/LoginForm.jsx - Version améliorée
...
const LoginForm = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-12 px-4 sm:px-6 lg:px-8 relative">
            {/* Background pattern */}
            ...
            <div className="max-w-md w-full space-y-8 relative z-10">
                ...
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200/50 dark:border-slate-700/50 p-8">
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pl-10 border rounded-xl bg-white/50 dark:bg-slate-700/50 backdrop-blur-sm transition-all duration-200 ${
                                            errors.email
                                                ...
                                                : 'border-gray-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500/20 dark:focus:border-blue-400'
                        ...
                        <div className="flex items-center justify-between pt-2">
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-slate-600 rounded transition-colors"
                                />
                                <label htmlFor="remember-me" className="ml-3 block text-sm text-gray-700 dark:text-slate-300">
                                    Se souvenir de moi
                                </label>
                            </div>
                            ...
                            <button
                                ...
                                className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-semibold rounded-xl text-white shadow-lg transform transition-all duration-200 ${
                                    loading
                                        ...
                                        : 'bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-4 focus:ring-blue-500/50 hover:scale-105 hover:shadow-xl'
                                }`}
                            >
                                {loading ? (
                                    <div className="flex items-center">
                    ...
                    <div className="text-center">
                        <Link
                            to="/register"
                            className="inline-flex items-center px-6 py-2 border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 font-semibold rounded-xl hover:bg-blue-50 dark:hover:bg-slate-700 transition-all duration-200 hover:scale-105"
                        >
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-center">
                    <Link
                        to="/"
                        className="inline-flex items-center text-sm text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                    >
